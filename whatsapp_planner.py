...
st.markdown("**Made with love by Aayush Nayak** • Get deep insights • Download stunning PDF")
...
def create_pdf_report(df, figs):
    ...
    story.append(Paragraph("Generated by WhatsApp Analyzer PRO • Aayush Nayak", styles['Center']))
...
if uploaded_file:
    ...
    if st.button("Export Full Report as PDF (with headings & captions)", type="primary"):
        with st.spinner("Generating professional PDF report..."):
            ...
            href = f'<a href="data:application/pdf;base64,{b64}" download="WhatsApp_Chat_Report_by_Aayush.pdf">Download Your Professional PDF Report</a>'
